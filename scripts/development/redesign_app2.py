...
new_end = '''      </div>
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="absolute -inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[var(--color-accent-purple)] opacity-5 blur-3xl translate-y-20 md:translate-y-0 transition-y-200 md:translate-y-0" />
          <div className="absolute bottom-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-[var(--color-accent-blue)] opacity-5 blur-3xl translate-y-20 md:translate-y-0 transition-y-200 md:translate-y-0" />
        </div>
      </div>
    </>'''
