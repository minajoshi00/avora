  ...
  return (
    <section id="demo" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-[min(500px,88vw)] h-[min(500px,88vw)] rounded-full bg-blue-500/3 blur-3xl avora-drift" />
        <div className="absolute bottom-1/3 right-1/4 w-[min(400px,80vw)] h-[min(400px,80vw)] rounded-full bg-purple-500/3 blur-3xl avora-drift" />
      </div>
