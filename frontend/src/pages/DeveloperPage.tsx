...
export function ContactSection() {
  const socials = [
    { name: 'GitHub', icon: GitBranch, href: 'https://github.com/minajoshi00/avora', color: 'text-gray-300' },
    { name: 'Email', icon: Mail, href: 'mailto:contact@avora.ai', color: 'text-blue-400' },
    { name: 'LinkedIn', icon: Link, href: 'https://linkedin.com/in/avora-ai', color: 'text-cyan-400' },
  ];
