    ...
    <section className="relative py-32">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex gap-2 mb-6 justify-center">
          <button className="px-4 py-2 rounded-full border border-white/[0.1] bg-white/[0.02] text-sm text-gray-300 hover:bg-white/[0.04] transition-all hover-target">
            Start a project
          </button>
          <button className="px-4 py-2 rounded-full border border-white/[0.1] bg-white/[0.02] text-sm text-gray-300 hover:bg-white/[0.04] transition-all hover-target">
            Analyze data
              ...
              <div className="p-4 border-t border-white/[0.06]">
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative">
                    <div className="flex-0 w-14 rounded-full bg-white/[0.02] border border-white/[0.08] flex items-center justify-center p-1 hover-target transition-all hover:bg-white/[0.04]">
                      <motion.button
                      ...
                      <button className="p-2 rounded-lg bg-gradient-to-r from-green-500 to-emerald-500 text-white">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                        </svg>
                      </button>
                      <button className="p-2 rounded-lg bg-gray-600/30 text-gray-300 hover:bg-gray-600/40 transition-all">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.75 3.75l-3.75 3.75 1.5 1.5-3.75 3.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </button>
                    </div>
                  </div>
